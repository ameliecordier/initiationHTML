# -*- coding: utf-8 -*-
#
# intro-web build configuration file, created by
...
import sys, os, datetime, sphinx_bootstrap_theme
...
project = u'HTML5 and CSS3 for teens'
copyright = u'2016-{}, Amélie Cordier'.format(
...
#html_theme = 'sphinx-ac-theme'

html_theme_path = sphinx_bootstrap_theme.get_html_theme_path()  + ['../themes']
html_theme = 'bootstrap'


#varBootStrap = sphinx_bootstrap_theme.get_html_theme_path().append('../themes')
#varMe = '../themes'
...
html_title = "HTML5 and CSS3 for teens"  ## overridden to remove "documentation"
